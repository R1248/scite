...
const ControlPanel: FC<ControlPanelProps> = ({ setDisplayPortfolio }) => {
  return (
      ...
      >
        ...
        <div className="row-span-3 flex h-full flex-col">
          ...
          <div className="mt-auto flex h-1/3 flex-row content-end">
            <button className="ml-auto flex h-full w-32 flex-row items-center bg-green-500 text-xl hover:bg-green-400">
